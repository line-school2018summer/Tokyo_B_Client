...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
     ...
     */
    private var mAuthTaskLogin: UserLoginTask? = null
    ...
    private fun attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true)
            mAuthTaskLogin = UserLoginTask(emailStr, passwordStr)
            mAuthTaskLogin!!.execute(null as Void?)
        }
    }
    ...
    private fun attemptRegister() {
        ...
        if (cancel) {
            ...
            // perform the user login attempt.
            showProgress(true)
            mAuthTaskRegister = UserRegisterTask(emailStr, passwordStr)
